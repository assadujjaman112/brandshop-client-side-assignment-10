...
const Home = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-center text-3xl md:text-4xl lg:text-5xl font-bold mb-4 ">All <span className="text-red-400">Brands</span></h1>
      <p className="text-center w-11/12 md:w-4/6 mb-5 md:mb-9 lg:w-1/2 mx-auto">The technology industry, often referred to as tech, encompasses a diverse and dynamic range of companies and innovations that shape the way we live, work, and communicate in the modern world.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-11/12 md:w-4/5 mx-auto">
        {allBrands.map((brand) => <SingleBrand key={brand.id} brand = {brand}></SingleBrand>)}
      </div>
    </div>
  );
};
